...
## Morpho-subwords
Now comes our rock-star section, morpho-subwords of Turkish. For this part, we needed some more data preparation steps. Before all, let's start easy and see how coverage works:
...
<table style="width:100%; border-collapse:collapse;">
  <tr>
    <td align="center" style="width:50%; padding:6px;">
      ...
      <div style="margin-top:6px; font-size:0.95em; color:#555;">(a) Morph-level attributions on sample inputs</div>
    </td>
    <td align="center" style="width:50%; padding:6px;">
      ...
      <div style="margin-top:6px; font-size:0.95em; color:#555;">(b) Aggregate importance vs. frequency</div>
    </td>
  </tr>
</table>
