...
<div style="width:100vw; margin-left:calc(50% - 50vw); margin-right:calc(50% - 50vw);">
  <div style="display:flex; gap:16px; padding:0 16px; flex-wrap:wrap;">
    ...
    <div style="flex:1 1 320px;">
      <img src="{{ 'assets/images/blog/8mart/wordcloud_verb.png' | relative_url }}"
           alt="Wordcloud (verbs)"
           style="width:100%; height:auto; display:block;">
    </div>
  </div>
...
Soldan saga gidersek, once isimleri goruyoruz, belirgin isimlerde koleksiyon, iliski ve tasarimci var, daha ufak boylarda ise marka, hediye, koku, deneyim, dunya, sac, parca, urun, saglik, yemek, moda, hayat ve duygu sozcuklerini goruyorum.
