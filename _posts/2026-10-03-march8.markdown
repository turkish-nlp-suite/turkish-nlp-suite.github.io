...
Veriseti ne olursa olsun, konu ne olursa olsun bir verisetini olcup bicmenin ilk adimi tabi ki kendisini olusturan en atomik parcalara - yani yani sozcuklere bakmaktir. 
...
<div style="display:flex; gap:12px; width:100%; flex-wrap:wrap; align-items:flex-start;">
  ...
  <figure style="flex:1 1 280px; margin:0;">
    <img
      src="{{ 'assets/images/blog/8mart/wordcloud_verbs.png' | relative_url }}"
      alt="Wordcloud (verbs)"
      style="width:100%; height:auto; display:block;"
      loading="lazy"
    >
